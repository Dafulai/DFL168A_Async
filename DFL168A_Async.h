...
public:
	class DFL168A * Pareant;
	PGN65268Class();
	PGN65268Class(class DFL168A * Pareant);
	byte refresh();
	bool getTirePressure(int &TirePressure);   //0 to 1000kPa,  4kPa/bit, 0 offset
	bool getTireTemperature(float &Temperature);   //-273 to 1734.96875 deg C, 0.03125 deg C/ Bit,   -273 deg C offset
	bool getTireLocation(int &Front2RearNumber, int &Left2RighNumber);   //Front2RearNumber is high order 4 bits, Left2RighNumber is low order 4 bits
	bool getTireValvePressureMonitor(int &TireValvePressureMonitor);   //0b 000 to 0b111: 000 extreme high pressure,.....
private:
	boolean SuccessFresh;
	String FreshResultStr;
};
...
class J1939Class
{
  ...
  public:
   ...
   PGN65268Class PGN65268;  //version 1.1.0 add
...
class DFL168A
{
   ...
   friend class PGN65268Class;    //version 1.1.0 add
   public:
    DFL168A();
