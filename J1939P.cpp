...
//version 1.1.0 add ---start
PGN65268Class::PGN65268Class() {
	SuccessFresh = false;
	Pareant = NULL;
}
PGN65268Class::PGN65268Class(class DFL168A * Pareant) {
	SuccessFresh = false;
	this->Pareant = Pareant;
}
//version 1.1.0 add ---end
...
J1939Class::J1939Class() :PGN65256(), PGN65269(), PGN65257(), PGN61444(), PGN61443(), PGN65270(), PGN65271(), PGN65272(), PGN65266(), PGN65263(), PGN65253(), PGN65214(), PGN65248(), PGN65276(), PGN65265(), PGN57344(), PGN65267(), PGN65262(), PGN64996(), PGN61445(), PGN65268() {
	Baudrate = 250000;  //250k
	Pareant = NULL;
}

J1939Class::J1939Class(long Baudrate, class DFL168A * Pareant) : PGN65256(Pareant), PGN65269(Pareant), PGN65257(Pareant), PGN61444(Pareant), PGN61443(Pareant), PGN65270(Pareant), PGN65271(Pareant), PGN65272(Pareant), PGN65266(Pareant),
PGN65263(Pareant), PGN65253(Pareant), PGN65214(Pareant), PGN65248(Pareant), PGN65276(Pareant), PGN65265(Pareant), PGN57344(Pareant), PGN65267(Pareant), PGN65262(Pareant), PGN64996(Pareant), PGN61445(Pareant), PGN65268(Pareant) {
	this->Baudrate = Baudrate;
	this->Pareant = Pareant;
}
//version 1.1.0 add  ----end
...
//version 1.1.0 add ----start
byte PGN65268Class::refresh()
{
	byte temp;
	temp = Pareant->DigitalCommand("FEF4");
	if (WAITING == temp) { SuccessFresh = false; return WAITING; }
	if (FAIL == temp) { SuccessFresh = false; return FAIL; }
	//if (!Pareant->DigitalCommand("E000")) { SuccessFresh=false; return false;}  
	Pareant->HandleResponse(Pareant->ReturnStr);
...
bool PGN65268Class::getTirePressure(int &TirePressure)  //0 to 1000kPa,  4kPa/bit, 0 offset
{
	char Hex1Byte[] = "0x00";
	long tempV;
	if (!SuccessFresh) return false;
	...
	tempV = strtol(Hex1Byte, NULL, 16);
	if (tempV>0xfa) return false;
	TirePressure = tempV * 4;
	return true;
}

bool PGN65268Class::getTireTemperature(float &Temperature)   //-273 to 1734.96875 deg C, 0.03125 deg C/ Bit,   -273 deg C offset
{
	char Hex2Byte[] = "0x0000";
	long tempV;
	if (!SuccessFresh) return false;
	...
	tempV = strtol(Hex2Byte, NULL, 16);
	if (tempV>0xfaff) return false;
	Temperature = tempV * 0.03125-273;
	return true;
}

bool PGN65268Class::getTireLocation(int &Front2RearNumber, int &Left2RighNumber)    //Front2RearNumber is high order 4 bits, Left2RighNumber is low order 4 bits
{
	char Hex1Byte[] = "0x00";
	long tempV;
	if (!SuccessFresh) return false;
	...
	tempV = strtol(Hex1Byte, NULL, 16);
	if (tempV>0xfa) return false;
	Front2RearNumber= tempV>>4;
	Left2RighNumber = tempV & 0x0f;
	return true;
}

bool PGN65268Class::getTireValvePressureMonitor(int &TireValvePressureMonitor)   // 8th byte high 3 bits:  0b 000 to 0b111: 000 extreme high pressure,.....
{
	char Hex1Byte[] = "0x00";
	long tempV;
	if (!SuccessFresh) return false;
	...
	Hex1Byte[3] = FreshResultStr.charAt(15);
	tempV = strtol(Hex1Byte, NULL, 16);
	if ((tempV&0b11100000)==0b11100000) return false;   
	TireValvePressureMonitor = tempV >> 5;
	return true;
}
//version 1.1.0 add ----end
